...
export const getPositions   = (sk='latest')=>cached('/position',            { session_key: sk },   5_000)
export const getLaps        = (sk,dn)     => cached('/laps',                { session_key:sk, driver_number:dn }, 8_000)
export const getAllLaps      = (sk='latest')=>cached('/laps',                { session_key: sk },   20_000)
...
export const getIntervals   = (sk='latest')=>cached('/intervals',           { session_key: sk },   5_000)
export const getRaceControl = (sk='latest')=>cached('/race_control',        { session_key: sk },   15_000)
